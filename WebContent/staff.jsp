...
<body>
    ...
    <form name="emp" action="" onsubmit="return validate_form();" method="post">
        <table align="center" width=40% width="100%" cellspacing="2" cellpadding="2" border="5">
            ...
            <tr>
                <td align="left" valign="top" width="41%">teacher Name<span style="color:red">*</span></td>
 
                <td width="57%"><input type="text" value="" name="teacher_name" size="24"></td>
            </tr>
            <tr>
                <td align="left" valign="top" width="41%">teacher registration number<span style="color:red">*</span></td>
                <td width="57%">
...
<option value="B.EI.E.D">B.EI.E.D</option>
            ...
            <tr>
                ...
                <td width="57%"><input type="text" value="" name="designation" size="24"></td>
            </tr>
             <tr>
                 <td align="left" valign="top" width="41%">applying for subject</td> 
                  
                <td width="57%"><input type="text" value="" name="applying for subject" size="24"></td>
                </tr>
