...
<div class="form-group">
  ...
  <label class="col-md-4 control-label">languages known</label>
    ...
    <select name="languages known" class="form-control selectpicker">
...
<div class="form-group">
  <label class="col-md-4 control-label" >subjects Thought</label> 
    ...
    <div class="input-group">
  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
  <input name="Subjects_Thouht" placeholder="Subjects thought" class="form-control"  type="text">
    </div>
  </div>
</div>
...
<div class="form-group">
  <label class="col-md-4 control-label" >Class Assigned</label> 
    ...
    <div class="input-group">
  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
  <input name="Class_Assigned" placeholder="Class" class="form-control"  type="text">
    </div>
  </div>
</div>
...
<div class="form-group">
  <label class="col-md-4 control-label" >Section Alotted</label> 
    ...
    <div class="input-group">
  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
  <input name="Section_alotted" placeholder="Section" class="form-control"  type="text">
    </div>
  </div>
</div>
<!-- Text input-->
